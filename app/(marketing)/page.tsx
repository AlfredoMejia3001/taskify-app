        ...
        <div className="flex items-center justify-center flex-col">
          <div className={cn(
            ...
            <div className="mb-4 flex items-center border shadow-sm p-4
             bg-amber-100 text-amber-700 rounded-full uppercase">
               ...
               Gestor de tareas número 1
            </div>
            <h1 className="text-3xl md:text-6xl text-center text-neutral-800 md-6">
          ...
          <div className={cn(
            ...
            textFont.className,
              ...
              Colabora, gestiona proyectos y alcanza nuevos picos de productividad. Desde los rascacielos hasta la oficina en casa, la forma en que trabaja tu equipo es única: logra todo con Taskify.
              </div>
